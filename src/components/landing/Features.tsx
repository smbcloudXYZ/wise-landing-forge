...
const Features = () => {
  return <section id="features" className="py-20 md:py-32 bg-background">
      <div className="container">
        <div className="text-center max-w-2xl mx-auto mb-16">
          <h2 className="text-3xl md:text-5xl font-bold text-foreground">Why Blockchain Expense Management?</h2>
          <p className="mt-4 text-lg text-muted-foreground">Of course there are other ways to do Expense Management </p>
        </div>

        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => <div key={index} className="group p-6 rounded-2xl bg-muted hover:bg-primary/10 transition-all duration-300 animate-fade-up" style={{
